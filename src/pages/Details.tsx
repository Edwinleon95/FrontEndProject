...
const Details = () => {
    ...
    const fetchPokemon = useCallback(async () => {
        ...
        try {
            ...
            const historyData = `You are the Pokédex. Only provide the official Pokédex entry for ${response.data.name}, just like in the Pokémon video games. Keep it concise and informative.`;
